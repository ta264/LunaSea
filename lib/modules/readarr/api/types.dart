/// Library containing all type definitions for Readarr data.
library readarr_types;

part 'src/types/event_type.dart';
part 'src/types/history_sort_key.dart';
part 'src/types/model_action_type.dart';
...
part 'src/types/author_monitor_type.dart';
part 'src/types/sort_dir.dart';
part 'src/types/wanted_missing_sort_key.dart';
